  ...
  _createClass(VersionFile, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.hooks.done.tap("Webpack Version File", function () {
        ...
        // Write file to disk
        writeFile(_this.options.output, content, _this.options.verbose);
      });
    }
  }]);
